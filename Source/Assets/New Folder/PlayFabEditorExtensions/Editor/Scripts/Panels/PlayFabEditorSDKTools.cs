...
//                if(!EditorUtility.DisplayDialog("Latest SDK Installed!", "Remember to set your TitleId.", "Confirm", "Cancel"))
//                {
//                    PlayFabEditorMenu.OnSettingsClicked();
//                }

                PlayFabEditorDataService.UpdateScriptableObject();   
...
//                if(EditorUtility.DisplayDialog("Confirm SDK Installs", "This action will install the newest PlayFab SDK.", "Confirm", "Cancel"))
//                {
                    ImportLatestSDK();
 //               }
            }
        ...
        private static void RemoveSDK(bool prompt = true)
        {
            ...
            if(FileUtil.DeleteFileOrDirectory(PlayFabEditorDataService.envDetails.sdkPath))
            {
                ...
                // HACK in 5.4, this causes the upgrade to fail.
                if(prompt)
                {
